...
const QuotingModule = ({ navigateTo, db, appId, userId }) => {
    ...
    useEffect(() => { if (customers.length > 0 && !selectedCustomer) { setSelectedCustomer(customers[0]); setCustomerSearch(customers[0].name); } }, [customers, selectedCustomer]);
